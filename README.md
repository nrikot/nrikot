...
-   [Corporate Meeting AI Scriber](https://github.com/nrikot/corporate-meeting-ai-scriber) - An advanced meeting assistant built with Next.js, TypeScript, Supabase, Prisma, Clerk and powered by AI of your choice via OpenRouter. It joins your calls, transcribes the audio and uses RAG 9Retrieval-Augmented Generation) to generate Minutes of Meeting (MoM), action plans and to answer your context-specific questions based on your company docs (no hallucinate). A live demo can be found [Here](https://corporate-meeting-ai-scriber.vercel.app/)
