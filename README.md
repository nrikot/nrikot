...
-   [Corporate Meeting AI Scriber](https://github.com/nrikot/corporate-meeting-ai-scriber) - An advanced meeting assistant, powered by AI of your choice, that joins your calls, transcribes the audio and uses Retrieval-Augmented Generation (RAG) to generate Minutes of Meeting (MoM), action plans and answer context-specific questions based on your company docs (no hallucinate), where a live demo can be found [Here](https://corporate-meeting-ai-scriber.vercel.app/)
